    ...
    <div id="footer" class="container">
        <div class="row">
            <div class="span3 logo">
                ...
                <br><br>
                Lorem sequat ipsum dolor lorem sit amet, consectetur adipiscing dolor elit. Aenean nisl orci,
                condimentum.
                <br><br>
            ...
            <div class="span3">
                <h2>Newsletter</h2>
                Subscribe to our newsletter and we’ll keep you up-to-date with theme news and special deals. Get in
                touch
                everytime.
                <br><br>
                <div class="newsletter-container">
                    ...
                    <div id="waiting" style="display: none;">
                        <img src="<?php bloginfo('template_directory'); ?>/img/ajax-loader.gif" title="Loader"
                             alt="Loader">
                    </div>
                </div>
            </div>
